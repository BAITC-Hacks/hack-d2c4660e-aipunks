...
Один UID может быть заказчиком и владельцем одной карточки. Служебная роль хранится в `staffAccess`; Rules проверяют текущую роль и состояние аккаунта.
...
- В первом релизе один владелец события и карточки. Командные приглашения, заявки, бронь, платежи и iOS Firebase не включены.
