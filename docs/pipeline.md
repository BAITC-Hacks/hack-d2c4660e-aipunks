...
Firebase SDK настроен для Web и Android в проекте `hackalem-84547`. Текущий подбор всё ещё локальный; развёртывание GPT через Firebase Functions ожидает включения Blaze владельцем проекта. [Статус подключения](firebase.md).
