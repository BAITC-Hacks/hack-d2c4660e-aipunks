...
Текущий этап расширяет исходный подбор рабочими аккаунтами. Старое ограничение «без кабинетов и сохранения» больше не действует; заявок, бронирования и оплаты по-прежнему нет.
...
Local/cloud настройка — в [firebase.md](firebase.md), серверные сценарии — в [accounts-backend.md](accounts-backend.md).
