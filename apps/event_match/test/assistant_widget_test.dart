...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.pumpAndSettle();
      expect(find.text('Языки: русский'), findsOneWidget);
      expect(find.text('Подробнее о подрядчике'), findsOneWidget);
      await tester.tap(find.byTooltip('Закрыть подробности'));
      await tester.pumpAndSettle();
