    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Демо-каталог · один специалист за раз · до трёх вариантов с объяснением. Реальные контакты — в разделе опубликованных подрядчиков.',
          ...
          return Center(
            child: ConstrainedBox(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    if (widget.showHeading || controller.messages.isNotEmpty)
                      Row(
                        children: [
                          Expanded(
                            child: Text(
                              widget.showHeading ? 'Помощник' : 'Ваш подбор',
                              style: Theme.of(context).textTheme.titleLarge,
                            ),
                          ),
