...
import '../data/local_auth_gateway.dart';
...
class _AuthPageState extends State<AuthPage> {
  ...
  Widget build(BuildContext context) => AuthFrame(
    ...
    subtitle: _reset
        ...
        : widget.auth is LocalAuthGateway
        ? 'Локальный аккаунт для мероприятий и работы подрядчиком. Подтверждение email и восстановление пароля по почте пока не подключены.'
